...
in accordance with our usual convention (see Chapter 5).
...
both space \textit{and} time.  As discussed in Chapter 5, a
...
(previously studied in Chapter 4) that is subjected to an additional
