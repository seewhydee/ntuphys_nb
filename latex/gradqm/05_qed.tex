...
Remarkably, this gauge relation holds even if the electron lies on an
irregularly-shaped confinement region, rather than the nicely
symmetric annulus we have assumed.  So long as the magnetic flux is
threaded through a region encircled by the confinement region, the
energy spectrum---even if it does not have the exact form of
Eq.~\eqref{abcurves}---must be invariant whenever $\Phi_B$ changes by
a multiple of $h/e$.
