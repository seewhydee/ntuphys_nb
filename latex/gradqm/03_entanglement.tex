...
operator
\begin{equation}
  \hat{\rho}(q) = |q\rangle\langle q|.
  \label{project}
\end{equation}
Applying this operator to $|\psi\rangle$ gives the non-normalized
state vector
\begin{equation}
  |\psi'\rangle = \hat{\rho}(q) |\psi\rangle = |q\rangle \langle q|\psi\rangle.
\end{equation}
...
\begin{equation}
  \hat{\rho}(\alpha) \,=\, |\alpha\rangle\langle \alpha| \otimes  \hat{I}.
\end{equation}
...
\begin{equation}
  |\psi'\rangle \,=\, \hat{\rho}(\alpha)\, |\psi\rangle
