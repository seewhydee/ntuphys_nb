...
In linear algebra, there is a concept called the \textbf{tensor
...
$\hvbox[+]{-}$, whereas if she got $-$, the hidden-variable state was
...
state, we call it a \textbf{mixed state}.
