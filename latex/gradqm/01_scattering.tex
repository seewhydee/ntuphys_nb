...
the particle is scattered in various directions.  Sometimes, we write
it using the alternative notation
\begin{equation}
...
Sec.~\ref{sec:scattering_amplitude}, $f$ contains the directional
information about the scattering process, stripping away the
$r$-dependence (which does not contain information about the
scatterer, since at for large $r$ it is entirely determined by
