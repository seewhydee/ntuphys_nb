...
state is normalization (check this; it requires $|\mu\rangle$ and
$|\nu\rangle$ to be orthonormal to work out).
...
$|\phi_1\rangle$, $|\phi_2\rangle$, $\dots, |\phi_N\rangle$, each of
which is drawn from some orthonormal basis $\{|\mu\rangle\}$ for
...
quantum mechanics, which will be discussed in Chapter 4; after having
