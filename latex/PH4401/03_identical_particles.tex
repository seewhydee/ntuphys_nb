...
\begin{align}
  ...
  \end{aligned}
\end{align}
The exchange symmetry operators have the following effects:
\begin{align}
  \begin{aligned}
...
It is helpful to look at a couple of concrete examples.  First,
consider $N=2$.  The sequence $\{1,2\}$ has two permutations:
\begin{align}
  \begin{aligned}
...
form
\begin{equation}
  U(x) = 2 \rho \sum_n|A_n|^2 \, |\varphi_n(x)|^2,
  \label{Edensity}
\end{equation}
...
energy is
\begin{equation}
  E = \int_0^L dx \; U(x) = 2  \rho \sum_n |A_n|^2.
...
\begin{equation}
  ...
  \label{fxt}
\end{equation}
which we is the quantum version of the classical solution
\eqref{fnorm}.
...
\begin{equation}
  \hat{a}_n |\alpha_1, \alpha_2, \dots\rangle =
  \alpha_n |\alpha_1, \alpha_2, \dots\rangle,
\end{equation}
whose energy expectation value is
\begin{equation}
