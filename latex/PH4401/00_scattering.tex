...
normalized'', rather than being normalized to unity.  Here,
$\delta^d(\cdots)$ denotes the $d$-dimensional delta function; e.g.,
in 2D,
\begin{equation*}
...
$|\mathbf{k}\rangle$ eigenstates are both delta-function normalized.
Note: in deriving the above, it is helpful to use the formula
\begin{equation}
