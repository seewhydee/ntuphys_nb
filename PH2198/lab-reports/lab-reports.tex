...
\item \textit{Curve fits must make sense}---When fitting data, you
  ...
  \begin{figure}[h]
  \centering
  \fbox{\includegraphics[width=0.5\textwidth]{bad-curve-fit.jpg}} \\
...
\begin{figure}[h]
  \centering
  \fbox{\includegraphics[width=0.73\textwidth]{bad-example-1.png}} \\
...
\begin{figure}[h]
  \centering
  \fbox{\includegraphics[width=0.85\textwidth]{good-writeup.png}} \\
...
\begin{figure}
  \centering
  \fbox{\includegraphics[width=0.85\textwidth]{bad-example-4.png}} \\
...
\begin{figure}[h]
  \centering
  \fbox{\includegraphics[width=0.85\textwidth]{bad-conclusion.png}} \\
...
\begin{figure}[h]
  \centering
  \fbox{\includegraphics[width=0.85\textwidth]{good-conclusion.png}}
  \\
...
\begin{figure}
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{good-table.png}} \\
...
\begin{figure}
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{bad-example-2.png}} \\
...
\begin{figure}
  \centering
  \fbox{\includegraphics[width=0.6\textwidth]{bad-example-3.png}} \\
