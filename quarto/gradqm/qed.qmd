...
### The Aharonov–Bohm effect {#sec-aharonov–bohm-effect}
...
![](fig/diraccone.png){fig-align="center" width="270" fig-alt="Energy versus momentum for the Dirac Hamiltonian, consisting of an upper hyperbola (positive energy) and a lower hyperbola (negative energy)"}
...
![](fig/emissionrates.png){fig-align="center" width="500" fig-alt="Spontaneous emission rates (Einstein A coefficients) for the 2p to 1s transition in hydrogen, the 2p to 2s transition in lithium, and the 3p to 3s transition in sodium, compared to the prediction of Fermi's Golden Rule"}
