...
1. In this exercise, we work through a line of reasoning that yields
   the Pauli matrix algebra, @eq-pauli-algebra.  As discussed in
   ...
   Hermitian matrices that we seek to find.
    ...
    \hat{\sigma}_1\hat{\sigma}_2 = - \hat{\sigma}_3.$ From this, derive the
    commutation relations
	$$\left[\hat{\sigma}_i, \hat{\sigma}_j\right] = 2i\epsilon_{ijk}\, \hat{\sigma}_k.$$
    Hence, work out the Pauli algebra relations in @eq-pauli-algebra.
