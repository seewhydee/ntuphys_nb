...
Here is a brief summary/recap of the angular momentum story.  We start
by looking at wavefunctions (see @sec-wavefunctions), and how they
transform under various coordinate rotations.  We find that these
transformations can be formulated with the aid of three so-called
**orbital angular momentum** observables, $\hat{J}_1$, $\hat{J}_2$,
and $\hat{J}_3$ (one for each spatial axis), which satisfy
