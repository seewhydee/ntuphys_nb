...
There is a tension between postulates 3 and 4.  Postulate 3 describes
the state evolving smoothly, according to a *deterministic*
differential equation (the Schrödinger equation).  However, postulate
4 describes a *probabilitic* jump to another state, occurring abruptly
when a measurement is performed.  Thus, the act of measurement plays a
special role in quantum mechanics.  We will revisit this issue in
@sec-chapter-entanglement.
