...
be written as a linear combination of the others).  The four
coefficients $\alpha_0, \dots, \alpha_3$ must be real; were we to use
a complex linear combination, $\hat{A}$ would not be guaranteed to be
Hermitian.
...
$$\left[\hat{J}_i, \hat{J}_j\right] = i\hbar \sum_{k=1}^3 \epsilon_{ijk} \, \hat{J}_k.$$

We can derive this most directly using wavefunctions
(@sec-wavefunctions), in which case $\hat{J}_i$ refers to *orbital*
angular momentum (i.e., angular momentum tied to the motion of a
particle).
