...
mechanics, including our modern understanding of chemistry, materials
science, nuclear physics, etc.  However, there are a couple of things
that can be forseen to spell trouble:
...
* In postulate 3, the Schrödinger equation gives a privileged role to
  ...
  second remains an important unsolved problem.  This theoretical
  difficulty has a cool name: it is called the [problem of
...
* There is a tension between postulates 3 and 4.  Postulate 3
  ...
  *deterministic* differential equation (the Schrödinger equation).
  ...
  mechanics.  This has many surprising (and possibly troubling)
