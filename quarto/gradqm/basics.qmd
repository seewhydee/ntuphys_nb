...
$$\hat{H} = - J \sum_n \big(|n\rangle \, \langle n+1| \, + \, |n+1\rangle \, \langle n| \big),$$
where $J$ is some energy scale (the minus sign is customary).  We can
understand this Hamiltonian by considering how it would act on a
particle initialized in a position eigenstate $|n'\rangle$ at time $t
= 0$:
