...
us to introduce the concept of position coordinates without the extra
complications accompanying continuous variables (which we will handle
in @sec-wavefunctions).  Suppose a particle is constrained to discrete
points, or **sites**, arranged in a 1D or higher-dimensional grid
called a **lattice**:
