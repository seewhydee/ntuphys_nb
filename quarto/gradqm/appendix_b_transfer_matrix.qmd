...
![](fig/transfer_matrix_setup.png){fig-align="center" fig-alt="Diagram of a piecewise-constant 1D potential, with wave components psi_plus and psi_minus at two positions x_a and x_b"}
...
![](fig/transfer_step.png){fig-align="center" fig-alt="Diagram of a potential step at position x_0, with potential V_minus to the left and V_plus to the right"}
...
![](fig/transfer_matrix_setup2.png){fig-align="center" fig-alt="Diagram of a piecewise-constant potential consisting of N segments of lengths L_1, ..., L_N and potentials V_1, ..., V_N, surrounded by a region of potential V_0"}
...
![](fig/transfer_matrix_setup3.png){fig-align="center" fig-alt="Diagram of a 1D scattering setup, showing an incident wave from the left, a reflected wave, and a transmitted wave to the right"}

From the reflection and transmission coefficients, we can also define
the real quantities
$$R = |r|^2, \;\;\; T = |t|^2,$$
