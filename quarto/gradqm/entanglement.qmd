...
counter-intuitive features of quantum entanglement.  They intended for
...
hidden-variable theories.  The amazing thing about this proof, which
...
experimental evidence is reviewed in [a paper by Aspect](https://www.nature.com/articles/18296).
...
earliest quantum cryptography schemes, devised by Ekert in 1991.
...
We can use a toy model to illustrate this idea.
...
theory of random matrices.)  In this example, we
will choose $d_A = 100$.
...
<!-- Further Reading -->
<!--
1. Bransden \& Joachain, \S14.1---14.4, \S17.1--17.5
