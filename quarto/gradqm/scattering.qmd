...
* For $d = 2$, we can use polar coordinates $(r,\phi)$.

* For $d = 3$, we can use spherical coordinates $(r, \theta, \phi)$.

We can also fit the $d = 1$ case into this framework by letting
