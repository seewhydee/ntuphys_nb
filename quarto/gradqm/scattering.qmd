...
regularization in @eq-kregularization; other regularization choices
can be shown to yield propagators with different properties (see
\hyperref[ex:anticausal]{exercises}).  This regularization procedure
can also be expressed in terms of an infinitesimal shift in $E$,
...
function for a **causal Green's function**,
