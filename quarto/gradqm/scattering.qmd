...
This describes a spherical wave centered at the source $\mathbf{r}'$.
The wave is isotropic (i.e., independent of the direction of
$\mathbf{r} - \mathbf{r}'$), consistent with the fact that the source,
a delta function, has no preferred direction.  The amplitude of the
wave decreases inversely with $\Delta r = |\mathbf{r}-\mathbf{r}'|$,
consistent with flux conservation in 3D.
...
source at $\mathbf{r}'$ (the cause) to $\mathbf{r}$ (the effect).  We
can trace this behavior back to the regularization in
@eq-kregularization.  Equivalently, we can express it as an
infinitesimal shift in $E$,
...
In other words, the original definition of the Green's function is
replaced with a **causal Green's function**,
