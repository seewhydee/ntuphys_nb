...
Now insert a resolution of the identity, $\hat{I} = \sum_n |n\rangle\langle n|$, where $\{|n\rangle\}$ denotes the exact eigenstates of $\hat{H}$ (for a continuum off free states, the sum goes to an integral in the usual way):
...
factors in @eq-densityofstates} and @eq-psiknew have cancelled each
other, so that they do not appear in this result.
