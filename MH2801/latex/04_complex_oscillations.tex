...
\item
Taylor expand $z(t)$ in the parameter $\varepsilon$.  Then show that
in the limit $\varepsilon \rightarrow 0$, the re-parameterized form
for $z(t)$ reduces to the critically-coupled general solution.
