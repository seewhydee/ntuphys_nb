...
We will skip the proof that $k_B \ln W$ is the upper bound (which
implies the second law of thermodynamics).  The proof follows from a
mathematical result known as
