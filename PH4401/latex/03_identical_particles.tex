...
categories.  The first consists of ``force-carrying''
particles---photons (which carry the electromagnetic force), gluons
(which carry the strong nuclear force), and the $W/Z$ bosons (which
carry the weak nuclear force); all these particles are excitations of
bosonic quantum fields, similar to the one described in the previous
section.  The second category consists of ``particles of matter'',
such as electrons, quarks, and neutrinos; these are excitations of
...
difference, which we have not discussed so far, is that these modern
field theories can be made compatible with relativity.)  
