...
Hamiltonian.  In Appendix A, we describe a common numerical method,
...
quantities, but are linked by a linear relation (see Appendix A).  In
...
Appendix A).  The figure below shows numerical results obtained for
