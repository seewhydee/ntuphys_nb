...
$|\varphi\rangle$ after time $t$.  In order to calculate this, let us
...
Let us now take a closer look at the expression for the self-energy.
...
$$\begin{aligned}\mathrm{Im}\big[\Sigma(E)\big] &= \int d^dk\, \Big| \langle\psi_k| \hat{V}_1|\varphi\rangle\Big|^2 \; \lim_{\varepsilon\rightarrow0^+} \; \mathrm{Im}\left( \frac{1}{\displaystyle E-E_k+i\varepsilon}\right) \\ &= - \int d^dk\, \Big| \langle\psi_k| \hat{V}_1|\varphi\rangle\Big|^2 \; \lim_{\varepsilon\rightarrow0^+} \; \frac{\varepsilon}{\displaystyle (E-E_k)^2 + \varepsilon^2}.\end{aligned}$$
The Lorentzian curve in the integrand has the property that
